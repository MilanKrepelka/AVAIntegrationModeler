...
namespace AVAIntegrationModeler.Infrastructure.Infrastructure.Data;
...
public class EventDispatchInterceptor(IDomainEventDispatcher domainEventDispatcher) : SaveChangesInterceptor
{
    ...
    CancellationToken cancellationToken = new CancellationToken())
  {
    ...
    if (context is not AVAIntegrationModeler.Infrastructure.Data.AppDbContext appDbContext)
    {
