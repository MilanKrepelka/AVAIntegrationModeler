...
using AVAIntegrationModeler.Core.ProjectAggregate;
using AVAIntegrationModeler.Core.Services;
using AVAIntegrationModeler.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace AVAIntegrationModeler.UnitTests.Core.Services
{
